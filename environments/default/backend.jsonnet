...

{
  ...
  + k.core.v1.secret.metadata.withNamespace('spezistudyplatform')
  ...
  backend_config: k.core.v1.configMap.new('spezistudyplatform-backend-config', {
    PORT: '3003',
    MODE: 'DEV', 
    ALLOWED_ORIGINS: "('https://study.muci.sh', 'http://study.muci.sh'),http://127.0.0.1,http://localhost:5173",
    AUTH_URL: 'https://study.muci.sh/auth',
  ...
  + k.core.v1.configMap.metadata.withNamespace('spezistudyplatform'),
  ...
  + k.apps.v1.deployment.metadata.withNamespace('spezistudyplatform')
  ...
  + k.core.v1.service.metadata.withNamespace('spezistudyplatform'),
}